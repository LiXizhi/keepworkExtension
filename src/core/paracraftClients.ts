...
const ACTIONS = new Set(['health', 'world_status', 'world_files', 'get_scene_info', 'query_scene', 'read_scene_object', 'run_command', 'screenshot', 'camera_capture', 'open_world', 'exit', 'bring_to_front']);
